...
// FileInfo implements FileService
func (_d FileServiceWithTwirpValidation) FileInfo(ctx context.Context, fp1 *FileInfoRequest) (fp2 *FileInfoResponse, err error) {
	...
	return _d.FileService.FileInfo(ctx, fp1)
}
