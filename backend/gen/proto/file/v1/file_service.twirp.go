...
func NewFileServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) FileService {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "file.v1", "FileService")
	urls := [5]string{
		serviceURL + "FileInfo",
		serviceURL + "List",
...
func (c *fileServiceProtobufClient) FileInfo(ctx context.Context, in *FileInfoRequest) (*FileInfoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "file.v1")
	ctx = ctxsetters.WithServiceName(ctx, "FileService")
	ctx = ctxsetters.WithMethodName(ctx, "FileInfo")
	caller := c.callFileInfo
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *FileInfoRequest) (*FileInfoResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*FileInfoRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*FileInfoRequest) when calling interceptor")
					}
					return c.callFileInfo(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*FileInfoResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*FileInfoResponse) when calling interceptor")
				}
...
func (c *fileServiceProtobufClient) callFileInfo(ctx context.Context, in *FileInfoRequest) (*FileInfoResponse, error) {
...
func (c *fileServiceJSONClient) FileInfo(ctx context.Context, in *FileInfoRequest) (*FileInfoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "file.v1")
	ctx = ctxsetters.WithServiceName(ctx, "FileService")
	ctx = ctxsetters.WithMethodName(ctx, "FileInfo")
	caller := c.callFileInfo
...
func (c *fileServiceJSONClient) callFileInfo(ctx context.Context, in *FileInfoRequest) (*FileInfoResponse, error) {
	out := new(FileInfoResponse)
...
func NewFileServiceServer(svc FileService, opts ...interface{}) TwirpServer {
	...
	for _, opt := range opts {
		...
		case nil: // backwards compatibility, allow nil value for the argument
			continue
		default:
			panic(fmt.Sprintf("Invalid option type %T on NewFileServiceServer", o))
		}
	}
...
// FileServicePathPrefix is a convenience constant that could used to identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// that add a "/twirp" prefix by default, and use CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const FileServicePathPrefix = "/twirp/file.v1.FileService/"
...
func (s *fileServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "file.v1.FileService" {
...
func (s *fileServiceServer) serveFileInfo(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveFileInfoJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveFileInfoProtobuf(ctx, resp, req)
	default:
...
func (s *fileServiceServer) serveFileInfoJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FileInfo")
	...
	reqContent := new(FileInfoRequest)
	...
	handler := s.FileService.FileInfo
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *FileInfoRequest) (*FileInfoResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.FileService.FileInfo(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*FileInfoResponse)
	...
	// Call service method
	var respContent *FileInfoResponse
	func() {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *FileInfoResponse and nil error while calling FileInfo. nil responses are not supported"))
		return
	}
...
func (s *fileServiceServer) serveFileInfoProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FileInfo")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *fileServiceServer) serveList(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *fileServiceServer) serveListJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "List")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *fileServiceServer) serveListProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "List")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *fileServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "file.v1", "FileService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
