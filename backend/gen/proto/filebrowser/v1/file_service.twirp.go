...
const FileServicePathPrefix = "/twirp/filebrowser.v1.FileService/"
...
func (s *fileServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "filebrowser.v1.FileService" {
...
func (s *fileServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "filebrowser.v1", "FileService")
}
