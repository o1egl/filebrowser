...
// was not loaded in eager-loading.
func (e GroupEdges) GroupVolumeOrErr() ([]*GroupVolume, error) {
	if e.loadedTypes[2] {
...
func (gr *Group) QueryVolumes() *VolumeQuery {
	return NewGroupClient(gr.config).QueryVolumes(gr)
}

// QueryGroupVolume queries the "group_volume" edge of the Group entity.
func (gr *Group) QueryGroupVolume() *GroupVolumeQuery {
	return NewGroupClient(gr.config).QueryGroupVolume(gr)
}
