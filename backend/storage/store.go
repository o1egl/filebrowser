//go:generate ../../tools/bin/mockgen -destination mock/store_mock.go . Store
package storage
...
import (
	...
	"github.com/filebrowser/filebrowser/storage/sql/migrations"
	"github.com/filebrowser/filebrowser/storage/sql/mysql"
	"github.com/filebrowser/filebrowser/storage/sql/postgres"
	"github.com/filebrowser/filebrowser/storage/sql/sqlite3"
)
...
type UserStore interface {
	...
	GetUserByAuthProvider(ctx context.Context, provider string, token string) (*domain.User, error)
...
type UploadStore interface {
	GetUpload(ctx context.Context, id int64) (*domain.Upload, error)
	CreateUpload(ctx context.Context, upload *domain.Upload) (id int64, err error)
